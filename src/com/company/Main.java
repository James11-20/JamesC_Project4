...
public class Main {
    ...
    public static boolean bfs(Node start, String targetData) {
        return false; //TODO: remove this before starting step 1, it's only here to let the code compile before then
    }

    public static boolean dfsIterative(Node start, String targetData) {
        return false; //TODO: remove this before starting step 2, it's only here to let the code compile before then
    }
